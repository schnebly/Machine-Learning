...
walls = [(1, 1), (1, 2), (2, 1), (2, 2), (4,4), (4,5), (5,4), (5,5)]
specials = [(4, 3, "red", -2), (4, 0, "green", 4), (3, 0, "red", -2)]
cell_scores = {}
...
def try_move(dx, dy):
    ...
    for (i, j, c, w) in specials:
        if new_x == i and new_y == j:
            ...
            score += w
            if score > 0:
                print iterationNum, ": Success! score: ", score
            else:
                print iterationNum, ": Fail! score: ", score
            restart = True
            return
    #print "score: ", score
...
def restart_game():
    global player, score, me, restart, iterationNum;
